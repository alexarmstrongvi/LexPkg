...
# 1st party
from lexpkg.scripting import require_empty_dir, update_config
...
def test_update_config():
    ...
    assert update_config(original, update, allow_new_keys=True) == result
...
def test_require_empty_dir(monkeypatch, tmp_path):
    empty_dir = tmp_path / "path_to/empty_dir"
